...
Source: TZ v1.3 §21 ("Риски, зависимости и открытые решения"), Q-01..Q-08.
...
| Q-02 | MVP locales and URL policy are fixed (`ru`, `en`, `uz`; default `en`; locale detection enabled — see ADR-0010), but a translation-content fill plan/owners/deadlines are not set. | Phase 2/3 content rollout                                                        | — (not an ADR; a content plan)                                                                                                    | Product + Content  |
| Q-03 | Pricing model.                                                                                                                                                                    | Phase 1/5 (Catalog/Ordering)                                                     | **Resolved** — see ADR-0005: hybrid indicative pricing; quote-only `OrderLine`, non-binding "from" price on `ProductTranslation`. | —                  |
...
## Phase 1 open item (not in the original TZ's numbered Q-list)

| ID   | Question / risk                                                                                                                                                                                                 | Blocks                                                                   | Resolves into                                                                                                                                                          | Owner (per TZ)  |
| ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| Q-09 | Required company legal/registration fields are unset (TZ intro: "Обязательные реквизиты компании... требуют бизнес-утверждения до Sprint 1" — a business-approval item, not yet a numbered Q- entry in TZ §21). | Company onboarding UX (Phase 4), order contact/company display (Phase 5) | — (not an ADR; a business/legal field-list approval). `Company.metadata: Json?` is a deliberate placeholder in the Phase 1 schema, not a substitute for this decision. | Product + Legal |
